    ...
    <FormControl required={true} variant='filled' >
      ...
      >
        <Grid container style={{ marginLeft: "22px" }}>
          ...
          <Grid xs={4} item style={{ padding: "10px" }}>
            <FormControlLabel value="18:00-20:00" control={<Radio />} label="18:00-20:00" labelPlacement="bottom" />
          </Grid>
          <Grid xs={4} item style={{ padding: "10px" }}>
            <FormControlLabel value="20:00-22:00" control={<Radio />} label="20:00-22:00" labelPlacement="bottom" />
          </Grid>
          <Grid xs={4} item style={{ padding: "10px" }}>
            <FormControlLabel
              value="22:00-24:00"
